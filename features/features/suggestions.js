...
const statusMessages = {
    ...
    ACCEPTED: {
        text: '✅ - Accepted idea! Expect this to be implemented soon!',
        color: 0x34eb5b
    },
    DENIED: {
        text: '❌ - Thank you for the feedback! Unfortunatly we cannot proceed with your suggestion at this time.',
        color: 0xc20808
    }
}
...
const fetchSuggestionChannels = async (guildId) => {
    ...
    const result = await suggestionSchema.find(query)
...
module.exports = (client) => {
    ...
    client.on('message', message => {
        ...
        if (cachedChannelId && cachedChannelId === channel.id) {
            message.delete()
